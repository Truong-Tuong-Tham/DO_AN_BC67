 ...
 console.log("iduser",iduser);
  ...
  return (
    ...
    <div className="flex  bg-gray-100 min-h-screen">
     ...
     {/* Sidebar */}
     <div
       className="bg-white sticky z-50 top-0 left-0 h-screen shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out "
     >
