...
const AdminTemPlate = () => {
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        >
          <div className="space-y-6 cursor-pointer md:space-y-10 mt-10">
            <h1 onClick={() => navigate("/")} className="font-bold text-4xl text-center md:hidden">
              F<span className="text-teal-600">.</span>
            </h1>
  ...
  className={({ isActive }) =>
    isActive
      ? "text-sm font-medium text-white bg-teal-500 py-2 px-2 rounded-md transition duration-150 ease-in-out flex items-center"
