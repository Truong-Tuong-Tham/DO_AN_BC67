...
const Footer = () => {
  return (
    <div className="w-full h-auto flex items-center justify-center bg-green-950">
      <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          ...
          <div className="w-44 pt-6 md:pt-0">
            <a className="bg-white text-green-950 font-bold cursor-pointer justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
              Contact US
            </a>
          </div>
        </div>
