    ...
    <section className="text-gray-200 body-font bg-green-900">
      <div className="container px-5 py-12 lg:py-24 mx-auto">
        <div className="flex flex-col">
          ...
          <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-8 lg:mb-12">
            <h1 className="sm:w-2/5 text-white font-medium title-font text-xl lg:text-2xl mb-2 sm:mb-0">
              Freelancing Guides and Resources
            </h1>
            <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0 mt-4 sm:mt-0">
        ...
        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
          <div className="p-4 md:w-1/2 lg:w-1/3 sm:mb-0 mb-6">
            <div className="rounded-lg h-56 sm:h-64 overflow-hidden">
            ...
            <h2 className="text-lg lg:text-xl font-medium title-font text-white mt-5">How to Build a Winning Freelancer Profile</h2>
          ...
          <div className="p-4 md:w-1/2 lg:w-1/3 sm:mb-0 mb-6">
            ...
            <h2 className="text-lg lg:text-xl font-medium title-font text-white mt-5">Top Tips for Managing Freelance Projects</h2>
            <p className="text-sm lg:text-base leading-relaxed mt-2">
          ...
          <div className="p-4 md:w-1/2 lg:w-1/3 sm:mb-0 mb-6">
            ...
            <h2 className="text-lg lg:text-xl font-medium title-font text-white mt-5">Pricing Your Freelance Services</h2>
            <p className="text-sm lg:text-base leading-relaxed mt-2">
