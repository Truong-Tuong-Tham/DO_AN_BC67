...
const BannerLogoMaker = () => {
  return (
    <div className="flex flex-col lg:flex-row m-auto mt-10 rounded-3xl h-auto lg:h-[540px] p-10 bg-[#F1D3CE] text-center lg:text-left w-full max-w-[1150px]">
      {/* Text Section */}
      <div className="flex-1 flex flex-col p-4 lg:p-8">
        ...
        <a
          ...
          className="relative mx-auto lg:mx-0 w-[200px] md:w-[250px] overflow-hidden rounded-lg h-12 bg-gradient-to-br from-pink-400 via-purple-400 to-indigo-400 text-white font-bold px-8 py-3 transition-transform transform group hover:scale-105 hover:shadow-lg flex items-center justify-center"
        >
